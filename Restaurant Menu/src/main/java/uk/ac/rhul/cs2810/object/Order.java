...
public class Order {
  ...
  /** Returns the list of menu items the customer has ordered. */
  public Map<MenuItem, Integer> getOrderedItems() {
    return orderedItems;
  }

  /** Returns the table number the order came from. */
  ...
  /** Returns whether the order is prepared or not. */
  ...
  /**
   * The java equals method so a list can check if the order is contained in it.
   */
